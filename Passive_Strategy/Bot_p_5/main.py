...
def handle_events(events):
    ...
    global phase, enemy_choke_points, zone_active, zone_active_points, distance, zone_active_ticks, defence, ticks, strongest_enemy, enemy_start_points, hill_scores
    requests = []
    spawned_this_tick = 0
        ...
        if (
            ...
            if (
                ...
                for point in enemy_start_points:
                    spawned_this_tick += 1
                    total_ants += 1
                    requests.append(SpawnRequest(AntTypes.FIGHTER, id=None, color=None, goal=point))
                    my_energy -= stats.ants.Fighter.COST
