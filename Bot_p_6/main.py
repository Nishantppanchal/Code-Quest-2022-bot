...
def handle_events(events):
    ...
    global phase, enemy_choke_points, zone_active, zone_active_points, distance, zone_active_ticks, defence, ticks, strongest_enemy, enemy_start_points, hill_scores, current_goal
    requests = []
    spawned_this_tick = 0
    ...
    if phase == 3:
        if (
            ...
            len(worker_ants) < stats.general.MAX_ANTS_PER_PLAYER*0.90
        ):
            spawned_this_tick += 1
            total_ants += 1
